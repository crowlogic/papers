...
<\body>
  ...
  <math|K> is canonically conjugate to <math|<sqrt|h>>. In cases where the
  ...
  of <math|<sqrt|h>>. For example, in the case of a conformally invariant
  scalar field the appropriate label is <math|\<phi\>=\<varphi\><sqrt|h>>.
  With this understanding we can write for the functionals

  <\equation>
    \<Psi\><around*|(|x|)>=\<Psi\><around|[|<wide|h|~><rsub|i*j><around*|(|x|)>,\<phi\><around*|(|x|)>|]>
  </equation>

  <\equation>
    \<Phi\><around*|(|x|)>=\<Phi\><around|[|<wide|h|~><rsub|i*j><around*|(|x|)>,K<around*|(|x|)>,\<phi\><around*|(|x|)>|]>
  </equation>
  ...
  Isham and Nelson, and Blyth and Isham. To simplify the subsequent
  discussion we introduce the following definitions and rescalings of
  variables:
  ...
  <\equation>
    \<tau\><rsup|2>=-<frac|<frac|\<partial\><rsup|2>|\<partial\>*a<rsup|2>>*<sqrt|p>|<sqrt|p>>*
  </equation>
  ...
  necessary to make the functional integral in (5.15) converge. An
  alternative way of constructing the ground-state wave function for the
  ...
  <\equation>
    \<Psi\><rsub|0><around|(|a<rsub|0>,X<rsub|0>|)>=<big|int>\<cal-D\>*a*e<rsup|-I<rprime|'><around|[|a,X|]>>
  </equation>
...
<\references>
  <\collection>
    ...
    <associate|2.19|<tuple|31|10>>
    <associate|2.20|<tuple|32|10>>
    <associate|2.21|<tuple|33|10>>
    ...
    <associate|auto-5|<tuple|34|11>>
    <associate|auto-6|<tuple|54|15>>
    <associate|auto-7|<tuple|55|15>>
